...
namespace Statistics
{
    ...
    {
        #region IMPLEMENTATION OF METHODS FOR DOUBLE TYPE
        ...
        #region IMPLEMENTATION OF METHODS FOR DECIMAL TYPE
        ...
        public static decimal[] VMA(decimal[] values, long[] volumes, int period)
        {
            if (values == null) throw new ArgumentNullException("values");
            if (volumes == null) throw new ArgumentNullException("volumes");
            if (period > values.Length) throw new ArgumentException("period > values.Lenght");
